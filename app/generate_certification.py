...
def generate_certificates(name, courseName, date, id, instructor):
    ...
    cv2.putText(certificate_template_image, name.strip(), (160 + text_center_x, 290 + text_center_y), font, font_scale, color_red, thickness, line_type)
    ...
    cv2.putText(certificate_template_image,
                ...
                (65 + text_center_x, 320 + text_center_y), font, font_scale, color_black, thickness, line_type)
    cv2.putText(certificate_template_image,
                courseName.strip() ,
                (160 + text_center_x, 350 + text_center_y), font, font_scale, color_black, thickness, line_type)
    ...
    cv2.putText(certificate_template_image, instructor.strip(), (462 + text_center_x, 420 + text_center_y), font, font_scale,
                color_black, thickness, line_type)
