...
from .forms import InstructorCreateCourseForm, InstructorCreateLessonForm, InstructorCreateQuizzForm, InstructorCreateVideoForm, PasswordResetForm
...
def QUIZ(request, course_slug, quizz_slug):
    ...
    try:
        print("LLLLLLLLLLLLLLLLLLLLLL: ", quiz.result_set.get(quiz=quiz))
    except:
